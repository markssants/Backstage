    ...
    <div className="grid grid-cols-1 md:grid-cols-6 auto-rows-[minmax(180px,auto)] gap-6 p-6">
      ...
      <div className="md:col-span-4 md:row-span-2 relative overflow-hidden glass-card rounded-[2.5rem] p-6 md:p-8 text-white flex flex-col justify-between shadow-2xl border-white/5">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
          <div className="w-36 h-36 md:w-44 md:h-44 rounded-3xl bg-transparent md:bg-white/5 p-0 border-none md:border md:border-white/10 shrink-0 overflow-hidden group">
            <img src={event.logoUrl} alt={event.name} className="w-full h-full object-cover transition-transform group-hover:scale-110" />
          </div>
